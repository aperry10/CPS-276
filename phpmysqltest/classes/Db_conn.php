...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'aperry10';//this will be your WCC username
      $dbUsr = 'aperry10';//this will be your WCC username
      $dbPass = 'OBHX5Iup9sEA7sx';//this will be the password found in the video.
